...
## Requirements
- [ ] Provision a RHEL VM on Azure using the Marketplace image
- [ ] Expand the root disk during cloud-init to use the full allocated disk size
- [ ] Support spot (Azure low-priority / spot VMs) via `azure/modules/allocation/`
- [ ] Support optional CI integrations
