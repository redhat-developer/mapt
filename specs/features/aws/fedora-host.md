...
## Requirements
- [ ] Provision a Fedora EC2 instance (latest or specified version)
- [ ] Support spot instance allocation
- [ ] Support optional CI integrations (GitHub runner, Cirrus worker, GitLab runner)
- [ ] Write output files: `host`, `username`, `id_rsa`
- [ ] `destroy` cleans up stack, spot stack, S3 state
