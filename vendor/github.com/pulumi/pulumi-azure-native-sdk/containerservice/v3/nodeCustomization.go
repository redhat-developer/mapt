...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o NodeCustomizationOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *NodeCustomization) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
