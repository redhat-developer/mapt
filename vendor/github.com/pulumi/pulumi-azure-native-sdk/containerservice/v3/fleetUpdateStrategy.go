...
func NewFleetUpdateStrategy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerservice/v20250401preview:FleetUpdateStrategy"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20250801preview:FleetUpdateStrategy"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260201preview:FleetUpdateStrategy"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260302preview:FleetUpdateStrategy"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260601:FleetUpdateStrategy"),
		},
	})
