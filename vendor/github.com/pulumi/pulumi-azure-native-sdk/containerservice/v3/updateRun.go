...
func NewUpdateRun(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerservice/v20250401preview:UpdateRun"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20250801preview:UpdateRun"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260201preview:UpdateRun"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260302preview:UpdateRun"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260601:UpdateRun"),
		},
	})
