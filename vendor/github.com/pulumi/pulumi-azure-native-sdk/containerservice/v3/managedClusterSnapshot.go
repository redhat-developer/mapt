...
func NewManagedClusterSnapshot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerservice/v20260102preview:ManagedClusterSnapshot"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260202preview:ManagedClusterSnapshot"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260302preview:ManagedClusterSnapshot"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260402preview:ManagedClusterSnapshot"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260502preview:ManagedClusterSnapshot"),
		},
	})
