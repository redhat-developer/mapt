...
func NewFleetMember(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerservice/v20260201preview:FleetMember"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260302preview:FleetMember"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260601:FleetMember"),
		},
	})
