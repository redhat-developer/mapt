...
type AgentPool struct {
	...
	LocalDNSProfile LocalDNSProfileResponsePtrOutput `pulumi:"localDNSProfile"`
	...
	Status AgentPoolStatusResponsePtrOutput `pulumi:"status"`
...
func NewAgentPool(ctx *pulumi.Context,
	...
	if args.LocalDNSProfile != nil {
		args.LocalDNSProfile = args.LocalDNSProfile.ToLocalDNSProfilePtrOutput().ApplyT(func(v *LocalDNSProfile) *LocalDNSProfile { return v.Defaults() }).(LocalDNSProfilePtrOutput)
	}
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerservice/v20250701:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20250702preview:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20250801:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20250802preview:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20250901:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20250902preview:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20251001:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20251002preview:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260101:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260102preview:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260201:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260202preview:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260301:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260302preview:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260401:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260402preview:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260501:AgentPool"),
		},
		{
			Type: pulumi.String("azure-native:containerservice/v20260502preview:AgentPool"),
		},
	})
...
type AgentPoolArgs struct {
	...
	// Configures the per-node local DNS, with VnetDNS and KubeDNS overrides. LocalDNS helps improve performance and reliability of DNS resolution in an AKS cluster. For more details see aka.ms/aks/localdns.
	LocalDNSProfile LocalDNSProfilePtrInput
	// The maximum number of nodes for auto-scaling
...
// Configures the per-node local DNS, with VnetDNS and KubeDNS overrides. LocalDNS helps improve performance and reliability of DNS resolution in an AKS cluster. For more details see aka.ms/aks/localdns.
func (o AgentPoolOutput) LocalDNSProfile() LocalDNSProfileResponsePtrOutput {
	return o.ApplyT(func(v *AgentPool) LocalDNSProfileResponsePtrOutput { return v.LocalDNSProfile }).(LocalDNSProfileResponsePtrOutput)
}
...
// Contains read-only information about the Agent Pool.
func (o AgentPoolOutput) Status() AgentPoolStatusResponsePtrOutput {
	return o.ApplyT(func(v *AgentPool) AgentPoolStatusResponsePtrOutput { return v.Status }).(AgentPoolStatusResponsePtrOutput)
}
