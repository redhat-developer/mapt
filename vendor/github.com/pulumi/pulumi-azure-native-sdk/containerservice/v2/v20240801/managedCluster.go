...
func NewManagedCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20240801:ManagedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedCluster(ctx *pulumi.Context,
	...
	var resource ManagedCluster
	err := ctx.ReadResource("azure-native:containerservice/v20240801:ManagedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
