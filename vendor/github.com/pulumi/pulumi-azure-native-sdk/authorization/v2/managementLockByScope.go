...
func NewManagementLockByScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization:ManagementLockByScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementLockByScope(ctx *pulumi.Context,
	...
	var resource ManagementLockByScope
	err := ctx.ReadResource("azure-native:authorization:ManagementLockByScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
