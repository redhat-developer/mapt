...
// The system metadata relating to this resource.
func (o LookupPolicyDefinitionAtManagementGroupResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupPolicyDefinitionAtManagementGroupResult) commontypesv5.SystemDataResponse {
		return v.SystemData
