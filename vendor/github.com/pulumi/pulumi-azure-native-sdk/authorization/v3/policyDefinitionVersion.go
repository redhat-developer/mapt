...
func NewPolicyDefinitionVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:authorization/v20251101:PolicyDefinitionVersion"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20251201preview:PolicyDefinitionVersion"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260101preview:PolicyDefinitionVersion"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260601:PolicyDefinitionVersion"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260701:PolicyDefinitionVersion"),
		},
	})
