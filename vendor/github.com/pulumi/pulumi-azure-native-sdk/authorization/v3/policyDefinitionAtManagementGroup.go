...
func NewPolicyDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:authorization/v20251101:PolicyDefinitionAtManagementGroup"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20251201preview:PolicyDefinitionAtManagementGroup"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260101preview:PolicyDefinitionAtManagementGroup"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260601:PolicyDefinitionAtManagementGroup"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260701:PolicyDefinitionAtManagementGroup"),
		},
	})
