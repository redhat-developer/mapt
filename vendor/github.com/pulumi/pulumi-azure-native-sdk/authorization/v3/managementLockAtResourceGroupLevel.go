...
// Metadata pertaining to creation and last modification of the resource.
func (o ManagementLockAtResourceGroupLevelOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *ManagementLockAtResourceGroupLevel) commontypesv2.SystemDataResponseOutput {
		return v.SystemData
