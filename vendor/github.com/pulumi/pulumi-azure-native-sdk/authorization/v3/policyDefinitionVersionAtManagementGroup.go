...
func NewPolicyDefinitionVersionAtManagementGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:authorization/v20251101:PolicyDefinitionVersionAtManagementGroup"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20251201preview:PolicyDefinitionVersionAtManagementGroup"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260101preview:PolicyDefinitionVersionAtManagementGroup"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260601:PolicyDefinitionVersionAtManagementGroup"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260701:PolicyDefinitionVersionAtManagementGroup"),
		},
	})
