...
// The system metadata relating to this resource.
func (o PolicyDefinitionVersionAtManagementGroupOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *PolicyDefinitionVersionAtManagementGroup) commontypesv5.SystemDataResponseOutput {
		return v.SystemData
