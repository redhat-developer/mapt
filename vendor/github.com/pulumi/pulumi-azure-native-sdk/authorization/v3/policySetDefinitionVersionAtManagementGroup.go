...
func NewPolicySetDefinitionVersionAtManagementGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:authorization/v20260101preview:PolicySetDefinitionVersionAtManagementGroup"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260601:PolicySetDefinitionVersionAtManagementGroup"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260701:PolicySetDefinitionVersionAtManagementGroup"),
		},
	})
