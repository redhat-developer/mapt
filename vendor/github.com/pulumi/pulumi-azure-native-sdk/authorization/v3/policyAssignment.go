...
func NewPolicyAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:authorization/v20251101:PolicyAssignment"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20251201preview:PolicyAssignment"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260101preview:PolicyAssignment"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260601:PolicyAssignment"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260701:PolicyAssignment"),
		},
	})
