...
// The system metadata relating to this resource.
func (o PolicySetDefinitionVersionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *PolicySetDefinitionVersion) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
