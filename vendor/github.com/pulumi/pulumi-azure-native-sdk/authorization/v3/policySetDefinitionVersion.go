...
func NewPolicySetDefinitionVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:authorization/v20251101:PolicySetDefinitionVersion"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20251201preview:PolicySetDefinitionVersion"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260101preview:PolicySetDefinitionVersion"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260601:PolicySetDefinitionVersion"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20260701:PolicySetDefinitionVersion"),
		},
	})
...
// The Azure API version of the resource.
func (o PolicySetDefinitionVersionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *PolicySetDefinitionVersion) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
