...
func (o ListActiveSecurityAdminRuleResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListActiveSecurityAdminRuleResult] {
	return pulumix.Output[ListActiveSecurityAdminRuleResult]{
