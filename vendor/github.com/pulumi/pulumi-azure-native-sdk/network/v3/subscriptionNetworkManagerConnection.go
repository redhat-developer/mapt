...
func NewSubscriptionNetworkManagerConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:SubscriptionNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:SubscriptionNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:SubscriptionNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:SubscriptionNetworkManagerConnection"),
		},
	})
