...
func NewVirtualNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:VirtualNetwork"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VirtualNetwork"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VirtualNetwork"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VirtualNetwork"),
		},
	})
