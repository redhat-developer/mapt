...
func NewSecurityPartnerProvider(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:SecurityPartnerProvider"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:SecurityPartnerProvider"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:SecurityPartnerProvider"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:SecurityPartnerProvider"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:SecurityPartnerProvider"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:SecurityPartnerProvider"),
		},
	})
