...
func NewPublicIPPrefix(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:PublicIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:PublicIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:PublicIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:PublicIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:PublicIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:PublicIPPrefix"),
		},
	})
