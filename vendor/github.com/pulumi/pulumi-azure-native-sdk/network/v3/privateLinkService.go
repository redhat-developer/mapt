...
func NewPrivateLinkService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:PrivateLinkService"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:PrivateLinkService"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:PrivateLinkService"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:PrivateLinkService"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:PrivateLinkService"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:PrivateLinkService"),
		},
	})
