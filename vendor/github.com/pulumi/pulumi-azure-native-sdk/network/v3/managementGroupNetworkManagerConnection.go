...
func NewManagementGroupNetworkManagerConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:ManagementGroupNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:ManagementGroupNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ManagementGroupNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ManagementGroupNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ManagementGroupNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ManagementGroupNetworkManagerConnection"),
		},
	})
...
// The Azure API version of the resource.
func (o ManagementGroupNetworkManagerConnectionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ManagementGroupNetworkManagerConnection) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
