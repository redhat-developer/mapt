...
func NewRouteFilter(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20241001:RouteFilter"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:RouteFilter"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:RouteFilter"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:RouteFilter"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:RouteFilter"),
		},
	})
