...
func NewP2sVpnGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:P2sVpnGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:P2sVpnGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:P2sVpnGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:P2sVpnGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:P2sVpnGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:P2sVpnGateway"),
		},
	})
...
// The Azure API version of the resource.
func (o P2sVpnGatewayOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *P2sVpnGateway) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
