...
func NewIpamPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:IpamPool"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:IpamPool"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:IpamPool"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:IpamPool"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:IpamPool"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:IpamPool"),
		},
	})
