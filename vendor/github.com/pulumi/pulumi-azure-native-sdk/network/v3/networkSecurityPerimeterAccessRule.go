...
func NewNetworkSecurityPerimeterAccessRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:NetworkSecurityPerimeterAccessRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NetworkSecurityPerimeterAccessRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NetworkSecurityPerimeterAccessRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:NetworkSecurityPerimeterAccessRule"),
		},
		{
