...
func NewFirewallPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:FirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:FirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:FirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:FirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:FirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:FirewallPolicy"),
		},
	})
