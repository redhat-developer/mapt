...
func NewSecurityRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20241001:SecurityRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:SecurityRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:SecurityRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:SecurityRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:SecurityRule"),
		},
	})
