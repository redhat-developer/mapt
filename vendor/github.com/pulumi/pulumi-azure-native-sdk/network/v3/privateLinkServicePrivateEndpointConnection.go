...
func NewPrivateLinkServicePrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:PrivateLinkServicePrivateEndpointConnection"),
		},
	})
