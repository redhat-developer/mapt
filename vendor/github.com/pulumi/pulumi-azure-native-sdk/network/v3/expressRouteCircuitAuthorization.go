...
func NewExpressRouteCircuitAuthorization(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:ExpressRouteCircuitAuthorization"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ExpressRouteCircuitAuthorization"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ExpressRouteCircuitAuthorization"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ExpressRouteCircuitAuthorization"),
		},
	})
