...
func NewExpressRouteConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:ExpressRouteConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:ExpressRouteConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ExpressRouteConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ExpressRouteConnection"),
		},
		{
