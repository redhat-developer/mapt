...
func NewRouteFilterRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:RouteFilterRule"),
		},
	})
