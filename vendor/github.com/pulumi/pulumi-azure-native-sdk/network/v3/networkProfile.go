...
func NewNetworkProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:NetworkProfile"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:NetworkProfile"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:NetworkProfile"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NetworkProfile"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NetworkProfile"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:NetworkProfile"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NetworkProfile
	err := ctx.RegisterResource("azure-native:network:NetworkProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkProfile(ctx *pulumi.Context,
	...
	var resource NetworkProfile
	err := ctx.ReadResource("azure-native:network:NetworkProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o NetworkProfileOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *NetworkProfile) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
