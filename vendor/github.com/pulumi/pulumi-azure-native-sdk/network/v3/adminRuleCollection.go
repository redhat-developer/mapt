...
func NewAdminRuleCollection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:AdminRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:AdminRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:AdminRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:AdminRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:AdminRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:AdminRuleCollection"),
		},
	})
