...
func NewDscpConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:DscpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:DscpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:DscpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:DscpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:DscpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:DscpConfiguration"),
		},
	})
