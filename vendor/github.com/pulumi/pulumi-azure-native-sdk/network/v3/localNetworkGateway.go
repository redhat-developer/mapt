...
func NewLocalNetworkGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:LocalNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:LocalNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:LocalNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:LocalNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:LocalNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:LocalNetworkGateway"),
		},
	})
...
// The Azure API version of the resource.
func (o LocalNetworkGatewayOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *LocalNetworkGateway) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
