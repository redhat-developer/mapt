...
func NewVirtualHubIpConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:VirtualHubIpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:VirtualHubIpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:VirtualHubIpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VirtualHubIpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VirtualHubIpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VirtualHubIpConfiguration"),
		},
	})
