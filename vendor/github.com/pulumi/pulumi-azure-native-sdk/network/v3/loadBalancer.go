...
func NewLoadBalancer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:LoadBalancer"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:LoadBalancer"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:LoadBalancer"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:LoadBalancer"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:LoadBalancer"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:LoadBalancer"),
		},
	})
