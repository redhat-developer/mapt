...
func NewExpressRoutePortAuthorization(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:ExpressRoutePortAuthorization"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:ExpressRoutePortAuthorization"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ExpressRoutePortAuthorization"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ExpressRoutePortAuthorization"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ExpressRoutePortAuthorization"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ExpressRoutePortAuthorization"),
		},
	})
