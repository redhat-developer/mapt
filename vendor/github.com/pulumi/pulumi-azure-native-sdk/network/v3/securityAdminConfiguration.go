...
func NewSecurityAdminConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:SecurityAdminConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:SecurityAdminConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:SecurityAdminConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:SecurityAdminConfiguration"),
		},
	})
