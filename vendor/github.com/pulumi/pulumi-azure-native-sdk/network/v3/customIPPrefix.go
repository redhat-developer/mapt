...
func NewCustomIPPrefix(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:CustomIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:CustomIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:CustomIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:CustomIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:CustomIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:CustomIPPrefix"),
		},
	})
