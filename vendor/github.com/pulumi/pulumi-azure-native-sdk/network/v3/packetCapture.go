...
func NewPacketCapture(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:PacketCapture"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:PacketCapture"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:PacketCapture"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:PacketCapture"),
		},
	})
