...
func NewNetworkGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:NetworkGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NetworkGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NetworkGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:NetworkGroup"),
		},
	})
