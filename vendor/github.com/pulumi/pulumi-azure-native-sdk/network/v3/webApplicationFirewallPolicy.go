...
func NewWebApplicationFirewallPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20241001:WebApplicationFirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:WebApplicationFirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:WebApplicationFirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:WebApplicationFirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:WebApplicationFirewallPolicy"),
		},
	})
