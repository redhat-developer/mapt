...
func NewConnectionMonitor(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:ConnectionMonitor"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:ConnectionMonitor"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ConnectionMonitor"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ConnectionMonitor"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ConnectionMonitor"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ConnectionMonitor"),
		},
	})
