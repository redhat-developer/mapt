...
func NewVirtualNetworkGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:VirtualNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:VirtualNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:VirtualNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VirtualNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VirtualNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VirtualNetworkGateway"),
		},
	})
