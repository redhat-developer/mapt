...
func NewDdosCustomPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:DdosCustomPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:DdosCustomPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:DdosCustomPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:DdosCustomPolicy"),
		},
	})
