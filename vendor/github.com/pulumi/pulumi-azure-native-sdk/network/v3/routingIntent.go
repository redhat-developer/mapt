...
func NewRoutingIntent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:RoutingIntent"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:RoutingIntent"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:RoutingIntent"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:RoutingIntent"),
		},
	})
