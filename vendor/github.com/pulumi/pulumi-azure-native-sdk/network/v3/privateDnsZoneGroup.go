...
func NewPrivateDnsZoneGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:PrivateDnsZoneGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:PrivateDnsZoneGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:PrivateDnsZoneGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:PrivateDnsZoneGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:PrivateDnsZoneGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:PrivateDnsZoneGroup"),
		},
	})
