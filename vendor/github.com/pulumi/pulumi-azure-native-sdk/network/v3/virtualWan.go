...
func NewVirtualWan(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:VirtualWan"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VirtualWan"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VirtualWan"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VirtualWan"),
		},
	})
