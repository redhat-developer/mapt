...
func NewFirewallPolicyRuleCollectionGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:FirewallPolicyRuleCollectionGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:FirewallPolicyRuleCollectionGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:FirewallPolicyRuleCollectionGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:FirewallPolicyRuleCollectionGroup"),
		},
	})
