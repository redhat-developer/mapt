...
func NewVirtualRouter(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:VirtualRouter"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:VirtualRouter"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:VirtualRouter"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VirtualRouter"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VirtualRouter"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VirtualRouter"),
		},
	})
...
// The Azure API version of the resource.
func (o VirtualRouterOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *VirtualRouter) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
