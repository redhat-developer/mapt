...
func NewApplicationGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:ApplicationGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:ApplicationGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ApplicationGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ApplicationGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ApplicationGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ApplicationGateway"),
		},
	})
