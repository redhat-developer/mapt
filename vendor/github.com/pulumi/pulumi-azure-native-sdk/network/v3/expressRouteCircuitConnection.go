...
func NewExpressRouteCircuitConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:ExpressRouteCircuitConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:ExpressRouteCircuitConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ExpressRouteCircuitConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ExpressRouteCircuitConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ExpressRouteCircuitConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ExpressRouteCircuitConnection"),
		},
	})
