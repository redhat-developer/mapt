...
func NewServiceEndpointPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ServiceEndpointPolicy"),
		},
	})
...
// The Azure API version of the resource.
func (o ServiceEndpointPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ServiceEndpointPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
