...
func NewVirtualNetworkTap(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:VirtualNetworkTap"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:VirtualNetworkTap"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:VirtualNetworkTap"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VirtualNetworkTap"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VirtualNetworkTap"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VirtualNetworkTap"),
		},
	})
