...
func NewNatRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:NatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:NatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:NatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:NatRule"),
		},
	})
