...
func NewNetworkManager(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NetworkManager"),
		},
	})
