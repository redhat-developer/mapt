...
func NewNetworkSecurityGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:NetworkSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:NetworkSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:NetworkSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NetworkSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NetworkSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:NetworkSecurityGroup"),
		},
	})
