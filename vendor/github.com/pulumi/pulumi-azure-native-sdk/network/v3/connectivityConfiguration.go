...
func NewConnectivityConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20241001:ConnectivityConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ConnectivityConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ConnectivityConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ConnectivityConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ConnectivityConfiguration"),
		},
	})
