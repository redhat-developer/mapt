...
func NewIpGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:IpGroup"),
		},
	})
