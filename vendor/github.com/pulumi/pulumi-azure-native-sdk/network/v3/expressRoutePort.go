...
func NewExpressRoutePort(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:ExpressRoutePort"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ExpressRoutePort"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ExpressRoutePort"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ExpressRoutePort"),
		},
	})
