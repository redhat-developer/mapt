...
func NewNetworkManagerRoutingConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:network/v20230301preview:NetworkManagerRoutingConfiguration"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:NetworkManagerRoutingConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240901preview:NetworkManagerRoutingConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:NetworkManagerRoutingConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:NetworkManagerRoutingConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NetworkManagerRoutingConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NetworkManagerRoutingConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:NetworkManagerRoutingConfiguration"),
		},
	})
