...
func NewRoutingRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:network/v20230301preview:RoutingRule"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20240901preview:RoutingRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:RoutingRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:RoutingRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:RoutingRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:RoutingRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:RoutingRule"),
		},
	})
