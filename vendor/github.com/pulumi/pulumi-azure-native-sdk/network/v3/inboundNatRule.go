...
func NewInboundNatRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:InboundNatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:InboundNatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:InboundNatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:InboundNatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:InboundNatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:InboundNatRule"),
		},
	})
