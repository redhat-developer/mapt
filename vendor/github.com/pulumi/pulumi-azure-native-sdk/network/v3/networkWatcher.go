...
func NewNetworkWatcher(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:NetworkWatcher"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:NetworkWatcher"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:NetworkWatcher"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NetworkWatcher"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NetworkWatcher"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:NetworkWatcher"),
		},
	})
