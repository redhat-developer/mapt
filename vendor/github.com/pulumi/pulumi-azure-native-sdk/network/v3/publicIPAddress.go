...
func NewPublicIPAddress(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:PublicIPAddress"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:PublicIPAddress"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:PublicIPAddress"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:PublicIPAddress"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:PublicIPAddress"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:PublicIPAddress"),
		},
	})
