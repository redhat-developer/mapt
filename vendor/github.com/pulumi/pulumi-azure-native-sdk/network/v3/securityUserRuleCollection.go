...
func NewSecurityUserRuleCollection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:SecurityUserRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:SecurityUserRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:SecurityUserRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:SecurityUserRuleCollection"),
		},
		{
