...
func NewSecurityUserConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:SecurityUserConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:SecurityUserConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:SecurityUserConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:SecurityUserConfiguration"),
		},
	})
