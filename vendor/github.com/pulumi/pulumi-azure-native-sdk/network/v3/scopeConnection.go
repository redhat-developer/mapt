...
func NewScopeConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:ScopeConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:ScopeConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ScopeConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ScopeConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ScopeConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ScopeConnection"),
		},
	})
