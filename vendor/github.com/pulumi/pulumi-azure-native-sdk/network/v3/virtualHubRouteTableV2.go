...
func NewVirtualHubRouteTableV2(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:VirtualHubRouteTableV2"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:VirtualHubRouteTableV2"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:VirtualHubRouteTableV2"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VirtualHubRouteTableV2"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VirtualHubRouteTableV2"),
		},
	})
