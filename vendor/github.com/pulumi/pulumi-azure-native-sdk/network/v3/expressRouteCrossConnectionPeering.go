...
func NewExpressRouteCrossConnectionPeering(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:ExpressRouteCrossConnectionPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:ExpressRouteCrossConnectionPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ExpressRouteCrossConnectionPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ExpressRouteCrossConnectionPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ExpressRouteCrossConnectionPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ExpressRouteCrossConnectionPeering"),
		},
	})
...
// The Azure API version of the resource.
func (o ExpressRouteCrossConnectionPeeringOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ExpressRouteCrossConnectionPeering) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
