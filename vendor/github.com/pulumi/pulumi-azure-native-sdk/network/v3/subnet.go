...
func NewSubnet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:Subnet"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:Subnet"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:Subnet"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:Subnet"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:Subnet"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:Subnet"),
		},
	})
