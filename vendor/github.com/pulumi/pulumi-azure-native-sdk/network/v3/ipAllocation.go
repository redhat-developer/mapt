...
func NewIpAllocation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:IpAllocation"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:IpAllocation"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:IpAllocation"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:IpAllocation"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:IpAllocation"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:IpAllocation"),
		},
	})
