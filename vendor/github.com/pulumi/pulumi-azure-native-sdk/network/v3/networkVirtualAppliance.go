...
func NewNetworkVirtualAppliance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:NetworkVirtualAppliance"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:NetworkVirtualAppliance"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:NetworkVirtualAppliance"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NetworkVirtualAppliance"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NetworkVirtualAppliance"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:NetworkVirtualAppliance"),
		},
	})
