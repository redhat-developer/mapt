...
func NewPrivateEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20241001:PrivateEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:PrivateEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:PrivateEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:PrivateEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:PrivateEndpoint"),
		},
		{
