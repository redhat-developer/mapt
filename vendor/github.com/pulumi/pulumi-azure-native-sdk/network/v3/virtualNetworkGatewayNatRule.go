...
func NewVirtualNetworkGatewayNatRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:VirtualNetworkGatewayNatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VirtualNetworkGatewayNatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VirtualNetworkGatewayNatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VirtualNetworkGatewayNatRule"),
		},
	})
