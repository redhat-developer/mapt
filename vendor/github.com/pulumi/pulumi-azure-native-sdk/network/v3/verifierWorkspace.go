...
func NewVerifierWorkspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:VerifierWorkspace"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VerifierWorkspace"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VerifierWorkspace"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VerifierWorkspace"),
		},
	})
