...
func NewVirtualApplianceSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:VirtualApplianceSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:VirtualApplianceSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:VirtualApplianceSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VirtualApplianceSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VirtualApplianceSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VirtualApplianceSite"),
		},
	})
...
// The Azure API version of the resource.
func (o VirtualApplianceSiteOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *VirtualApplianceSite) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
