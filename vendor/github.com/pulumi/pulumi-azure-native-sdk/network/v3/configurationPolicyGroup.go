...
func NewConfigurationPolicyGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:ConfigurationPolicyGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ConfigurationPolicyGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ConfigurationPolicyGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ConfigurationPolicyGroup"),
		},
	})
