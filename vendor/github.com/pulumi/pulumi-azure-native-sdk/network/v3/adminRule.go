...
func NewAdminRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20250101:AdminRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:AdminRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:AdminRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:AdminRule"),
		},
		{
