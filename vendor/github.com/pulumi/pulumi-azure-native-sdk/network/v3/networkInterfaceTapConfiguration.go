...
func NewNetworkInterfaceTapConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:NetworkInterfaceTapConfiguration"),
		},
	})
