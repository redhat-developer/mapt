...
func NewStaticMember(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:StaticMember"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:StaticMember"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:StaticMember"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:StaticMember"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:StaticMember"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:StaticMember"),
		},
	})
