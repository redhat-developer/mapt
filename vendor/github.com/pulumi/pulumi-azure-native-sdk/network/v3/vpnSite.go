...
func NewVpnSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:VpnSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:VpnSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:VpnSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VpnSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VpnSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VpnSite"),
		},
	})
