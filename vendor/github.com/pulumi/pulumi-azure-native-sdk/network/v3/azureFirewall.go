...
func NewAzureFirewall(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:AzureFirewall"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:AzureFirewall"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:AzureFirewall"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:AzureFirewall"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:AzureFirewall"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:AzureFirewall"),
		},
	})
