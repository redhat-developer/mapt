...
func NewNetworkInterface(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:NetworkInterface"),
		},
	})
