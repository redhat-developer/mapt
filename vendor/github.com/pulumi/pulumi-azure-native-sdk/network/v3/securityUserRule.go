...
func NewSecurityUserRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20241001:SecurityUserRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:SecurityUserRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:SecurityUserRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:SecurityUserRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:SecurityUserRule"),
		},
		{
