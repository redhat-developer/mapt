...
func NewExpressRouteCircuit(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ExpressRouteCircuit"),
		},
	})
