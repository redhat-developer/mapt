...
func NewNatGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:NatGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:NatGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:NatGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:NatGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:NatGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:NatGateway"),
		},
	})
