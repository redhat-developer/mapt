...
func NewExpressRouteCircuitPeering(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:ExpressRouteCircuitPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:ExpressRouteCircuitPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:ExpressRouteCircuitPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:ExpressRouteCircuitPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:ExpressRouteCircuitPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:ExpressRouteCircuitPeering"),
		},
	})
...
// The Azure API version of the resource.
func (o ExpressRouteCircuitPeeringOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ExpressRouteCircuitPeering) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
