...
func NewVirtualRouterPeering(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:VirtualRouterPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:VirtualRouterPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:VirtualRouterPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VirtualRouterPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VirtualRouterPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VirtualRouterPeering"),
		},
	})
