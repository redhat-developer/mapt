...
func NewHubRouteTable(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:HubRouteTable"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:HubRouteTable"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:HubRouteTable"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:HubRouteTable"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:HubRouteTable"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:HubRouteTable"),
		},
	})
