...
// Metadata pertaining to creation and last modification of the resource.
func (o LookupLocalUserResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupLocalUserResult) commontypesv2.SystemDataResponse { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
