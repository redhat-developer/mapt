...
func NewLocalUser(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:storage/v20250601:LocalUser"),
		},
	})
...
// Metadata pertaining to creation and last modification of the resource.
func (o LocalUserOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *LocalUser) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
