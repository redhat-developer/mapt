...
func NewDeploymentAtSubscriptionScope(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:resources/v20250301:DeploymentAtSubscriptionScope"),
		},
		{
			Type: pulumi.String("azure-native:resources/v20250401:DeploymentAtSubscriptionScope"),
		},
	})
...
// The Azure API version of the resource.
func (o DeploymentAtSubscriptionScopeOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DeploymentAtSubscriptionScope) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
