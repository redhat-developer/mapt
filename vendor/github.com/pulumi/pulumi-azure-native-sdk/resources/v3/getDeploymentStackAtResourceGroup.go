...
// The error detail.
func (o LookupDeploymentStackAtResourceGroupResultOutput) Error() commontypesv6.ErrorDetailResponseOutput {
	return o.ApplyT(func(v LookupDeploymentStackAtResourceGroupResult) commontypesv6.ErrorDetailResponse { return v.Error }).(commontypesv6.ErrorDetailResponseOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupDeploymentStackAtResourceGroupResultOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDeploymentStackAtResourceGroupResult) commontypesv6.SystemDataResponse {
		return v.SystemData
