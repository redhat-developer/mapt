...
// List of script outputs.
func (o LookupAzurePowerShellScriptResultOutput) Outputs() pulumi.AnyOutput {
	return o.ApplyT(func(v LookupAzurePowerShellScriptResult) interface{} { return v.Outputs }).(pulumi.AnyOutput)
}
