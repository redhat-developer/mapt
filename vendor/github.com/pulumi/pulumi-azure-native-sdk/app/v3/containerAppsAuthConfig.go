...
func NewContainerAppsAuthConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app:ContainerAppsAuthConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerAppsAuthConfig(ctx *pulumi.Context,
	...
	var resource ContainerAppsAuthConfig
	err := ctx.ReadResource("azure-native:app:ContainerAppsAuthConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
