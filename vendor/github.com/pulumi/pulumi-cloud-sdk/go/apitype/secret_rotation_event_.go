...
type SecretRotationEvent struct {
	...
	PreRotationRevision int `json:"preRotationRevision" yaml:"preRotationRevision"`
	// The environment revision after the rotation, if completed.
	PostRotationRevision *int `json:"postRotationRevision,omitzero" yaml:"postRotationRevision,omitempty"`
