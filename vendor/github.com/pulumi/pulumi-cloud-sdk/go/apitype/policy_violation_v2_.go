...
type PolicyViolationV2 struct {
	...
	StackVersion *int `json:"stackVersion,omitzero" yaml:"stackVersion,omitempty"`
	...
	ResourceVersion *int `json:"resourceVersion,omitzero" yaml:"resourceVersion,omitempty"`
