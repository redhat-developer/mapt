...
type User struct {
	...
	// Whether the user is a synthetic agent account. Agent accounts cannot be authenticated except via their issued access token until a human
	// claims the account via the claim URL.
	IsAgent bool `json:"isAgent,omitzero" yaml:"isAgent,omitempty"`
}
