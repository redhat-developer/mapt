...
type CreateEnvironmentOpenRequest struct {
	...
	GrantExpirationSeconds int `json:"grantExpirationSeconds" yaml:"grantExpirationSeconds"`
	// Total duration that the resulting grant can be used to access the environment open endpoint (after first open)
	AccessDurationSeconds int `json:"accessDurationSeconds" yaml:"accessDurationSeconds"`
}
